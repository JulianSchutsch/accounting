...
const ref1 : BankAccountReference = BankAccountReference::SwedishAccountNumber(SwedishAccountNumber{number: 0});
const ref2 : BankAccountReference = BankAccountReference::SwedishAccountNumber(SwedishAccountNumber{number: 1});
fn ref3() -> BankAccountReference { BankAccountReference::NamedAccount(NamedAccount{name: "Name".to_string()}) }
